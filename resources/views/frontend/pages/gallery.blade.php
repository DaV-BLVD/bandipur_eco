...
<style>
    ...
    ::-webkit-scrollbar-thumb { background: #6d6d18; border-radius: 4px; }
</style>
@endpush
...
<section class="bg-[#fcfcfc] text-gray-800 antialiased selection:bg-[#6d6d18] selection:text-white">
    ...
    <section class="mx-auto container px-6 py-20 md:py-28 text-center bg-white relative">
        ...
        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[1px] h-20 bg-gradient-to-b from-transparent to-[#6d6d18]"></div>
        ...
        <div class="reveal-on-scroll">
            ...
            <p class="text-gray-500 text-lg md:text-xl font-['Lato'] font-light max-w-2xl mx-auto leading-relaxed">
                A curated collection of <span class="text-[#6d6d18] font-medium italic font-serif">golden sunsets</span>, green valleys, and heritage living.
            </p>
        </div>
    </section>
...
<script>
    ...
    const galleryData = [
        { src: "{{ asset('frontendimages/hotel_entrance.png') }}", category: "exterior", title: "The Main Lodge" },
        { src: "{{ asset('frontendimages/rooms/double.png') }}", category: "interiors", title: "Deluxe Suite" },
        { src: "{{ asset('frontendimages/tempels.png') }}", category: "culture", title: "Newari Architecture" },
        { src: "{{ asset('frontendimages/cusin.png') }}", category: "dining", title: "Morning Coffee" },
        { src: "{{ asset('frontendimages/site_view.png') }}", category: "exterior", title: "Sunrise View" },
        { src: "{{ asset('frontendimages/bath.png') }}", category: "interiors", title: "Royal Bathroom" },
        { src: "{{ asset('frontendimages/cusin.png') }}", category: "culture", title: "Bandipur Streets" },
        { src: "{{ asset('frontendimages/bandipureco.png') }}", category: "dining", title: "Traditional Dinner" },
        { src: "{{ asset('frontendimages/order.png') }}", category: "exterior", title: "The Terrace" }
    ];
