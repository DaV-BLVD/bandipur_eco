...
@section('title', 'Gallery Contents')
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-photo-video mr-2 text-primary"></i> Gallery Contents
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage images, titles, and categories for your main gallery section.
                </p>
            </div>

            <a href="{{ route('gallery-contents.create') }}"
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs text-primary font-medium mt-0.5">
                                        <i class="fas fa-folder text-[10px] mr-1"></i> {{ ucfirst($item->category) }}
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('gallery-contents.edit', $item) }}"
                                        ...
                                        {{-- Delete --}}
                                        <form method="POST" action="{{ route('gallery-contents.destroy', $item) }}"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No gallery items found.</p>
                                        <a href="{{ route('gallery-contents.create') }}"
                                            class="mt-2 text-primary hover:underline text-sm font-semibold">Upload your first image
                                        </a>
                                    </div>
                                </td>
                            </tr>
