        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-images mr-2 text-primary"></i> Hero Slider
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the home page carousel slides, content, and display order.</p>
            </div>

            <a href="{{ route('home-hero-slider.create') }}"
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-primary text-white">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest w-20">Order</th>
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Image</th>
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Title Preview</th>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="h-16 w-24 flex-shrink-0 overflow-hidden rounded-lg border border-gray-200 shadow-sm bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm">
                                        <span class="text-gray-400">{{ $slider->title_prefix }}</span>
                                        <span class="font-bold" style="color: {{ $slider->color_hex }}">
                                            {{ $slider->title_highlight }}
                                        </span>
                                        <span class="text-gray-600">{{ Str::limit($slider->title_suffix, 20) }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('home-hero-slider.edit', $slider->id) }}"
                                        ...
                                        {{-- Delete --}}
                                        <form action="{{ route('home-hero-slider.destroy', $slider->id) }}" method="POST"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No slider images found.</p>
                                        <a href="{{ route('home-hero-slider.create') }}"
                                            class="mt-2 text-primary hover:underline text-sm font-semibold">Add your first slide</a>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
