        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-heading mr-2 text-primary"></i> Contact Header
                </h1>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('contact-header.edit', $header) }}"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No contact headers found.</p>
                                        <a href="{{ route('contact-header.create') }}"
                                            class="mt-2 text-primary hover:underline text-sm font-semibold">Create your first contact header</a>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
