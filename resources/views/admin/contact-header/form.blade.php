        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            <div class="bg-primary px-8 py-6">
                <h1 class="text-2xl font-bold text-white tracking-tight flex items-center">
                    ...
                    {{ $header->exists ? 'Edit Contact Header' : 'Add New Contact Header' }}
                </h1>
                <p class="text-indigo-100/80 text-sm mt-1">Define the badge, main title, and description for the contact
                    section header.</p>
            </div>
            ...
            <div class="p-8">
                ...
                <form method="POST"
                    action="{{ $header->exists ? route('contact-header.update', $header) : route('contact-header.store') }}"
                    class="space-y-6">
                    @csrf
                    @if ($header->exists)
                        @method('PUT')
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Enter a brief description for the contact page...">{{ old('description', $header->description) }}</textarea>
                    </div>
