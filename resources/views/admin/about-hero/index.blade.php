{{-- resources/views/admin/about-hero/index.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'About Hero Images')
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-info-circle mr-2 text-primary"></i> About Hero
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage hero images and visibility for the "About Us" section.</p>
            </div>

            {{-- <a href="{{ route('about-hero.create') }}"
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            <img src="{{ asset('storage/' . $hero->image) }}"
                                                alt="{{ $hero->alt_text ?? 'About Hero Image' }}"
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('about-hero.edit', $hero) }}"
                                        ...
                                        {{-- Delete --}}
                                        {{-- <form method="POST" action="{{ route('about-hero.destroy', $hero) }}"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No about hero images found.</p>
                                        <a href="{{ route('about-hero.create') }}"
