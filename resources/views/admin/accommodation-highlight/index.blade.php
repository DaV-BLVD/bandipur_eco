{{-- resources/views/admin/accommodation-highlight/index.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'Accommodation Highlights')
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-star mr-2 text-primary"></i> Accommodation Highlights
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the amenities and key features displayed for your rooms.</p>
            </div>

            <a href="{{ route('accommodation-highlight.create') }}"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Amenity Title</th>
                        ...
                        @forelse($highlights as $item)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div
                                        class="w-10 h-10 rounded-lg bg-gray-50 border border-gray-200 flex items-center justify-center text-primary shadow-sm">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('accommodation-highlight.edit', $item) }}"
                                        ...
                                        {{-- Delete --}}
                                        <form method="POST" action="{{ route('accommodation-highlight.destroy', $item) }}"
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        <i class="fas fa-concierge-bell text-5xl text-gray-200 mb-4"></i>
                                        <p class="text-gray-500 font-medium">No amenities found.</p>
                                        <a href="{{ route('accommodation-highlight.create') }}"
