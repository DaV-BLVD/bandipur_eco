        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-images mr-2 text-primary"></i> Gallery Headers
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the badge text and main title for the gallery sections.</p>
            </div>

            <a href="{{ route('gallery-headers.create') }}"
                        ...
                        @forelse($headers as $header)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-bold rounded-md border border-gray-200">
                                        {{ $header->badge_text }}
                                    </span>
                                </td>
                                ...
                                {{-- Title --}}
                                <td class="px-6 py-4">
                                    <div class="text-sm font-bold text-gray-900 line-clamp-1">{{ $header->title }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('gallery-headers.edit', $header) }}"
                                        ...
                                        {{-- Delete --}}
                                        <form action="{{ route('gallery-headers.destroy', $header) }}" method="POST"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No gallery headers found.</p>
                                        <a href="{{ route('gallery-headers.create') }}"
                                            class="mt-2 text-primary hover:underline text-sm font-semibold">Create your first gallery header</a>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
