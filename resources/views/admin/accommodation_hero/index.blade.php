{{-- resources/views/admin/accommodation_hero/index.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'Accommodation Hero')
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-bed mr-2 text-primary"></i> Accommodation Hero
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage hero images and visibility for the accommodation section.</p>
            </div>

            {{-- <a href="{{ route('accommodation-hero.create') }}"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Alt Text</th>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            ...
                                            <img src="{{ asset('storage/' . $hero->image) }}" alt="{{ $hero->alt_text }}"
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-700">
                                        {{ $hero->alt_text ?: 'No alt text provided' }}
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('accommodation-hero.edit', $hero) }}"
                                        ...
                                        {{-- Delete --}}
                                        {{-- <form action="{{ route('accommodation-hero.destroy', $hero) }}" method="POST"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No accommodation hero images found.</p>
                                        <a href="{{ route('accommodation-hero.create') }}"
