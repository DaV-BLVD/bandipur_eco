        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-images mr-2 text-primary"></i> Rates Hero
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage hero images for the room rates listing page.</p>
            </div>

            <a href="{{ route('rates-hero.create') }}"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Hero Image</th>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="h-24 w-40 flex-shrink-0 overflow-hidden rounded-lg border border-gray-200 shadow-sm bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('rates-hero.edit', $hero) }}"
                                        ...
                                        {{-- Delete --}}
                                        <form method="POST" action="{{ route('rates-hero.destroy', $hero) }}" 
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No hero images found for rates.</p>
                                        <a href="{{ route('rates-hero.create') }}"
                                            class="mt-2 text-primary hover:underline text-sm font-semibold">Upload your first image</a>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
