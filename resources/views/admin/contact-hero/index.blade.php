        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-image mr-2 text-primary"></i> Contact Hero
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the hero section image and status for the contact page.</p>
            </div>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="h-20 w-32 flex-shrink-0 overflow-hidden rounded-lg border border-gray-200 shadow-sm bg-gray-50">
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No contact hero images found.</p>
                                        <a href="{{ route('contact-hero.create') }}"
                                            class="mt-2 text-primary hover:underline text-sm font-semibold">Upload your first hero image</a>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
