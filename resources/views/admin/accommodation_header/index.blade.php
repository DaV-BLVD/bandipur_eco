{{-- resources/views/admin/accommodation_header/index.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'Accommodation Header')
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-heading mr-2 text-primary"></i> Accommodation Header
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the badge text and main title for the accommodation page header.</p>
            </div>

            {{-- <a href="{{ route('accommodation-header.create') }}"
                        ...
                        @forelse($headers as $header)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-bold rounded-md border border-gray-200 uppercase tracking-tighter">
                                        {{ $header->badge_text }}
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('accommodation-header.edit', $header) }}"
                                        ...
                                        {{-- Delete --}}
                                        {{-- <form method="POST" action="{{ route('accommodation-header.destroy', $header) }}"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No accommodation headers found.</p>
                                        <a href="{{ route('accommodation-header.create') }}"
                                            class="mt-2 text-primary hover:underline text-sm font-semibold">Create your first header</a>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
