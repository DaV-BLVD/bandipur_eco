{{-- resources/views/admin/accommodation-highlight-pic/index.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'Accommodation Highlight Images')
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-images mr-2 text-primary"></i> Highlight Images
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the gallery images and ratings for the accommodation highlights
                    section.</p>
            </div>

            {{-- <a href="{{ route('accommodation-highlight-pic.create') }}"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Rating Label</th>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div
                                            class="h-20 w-32 flex-shrink-0 overflow-hidden rounded-lg border border-gray-200 shadow-sm bg-gray-50">
                                            <img src="{{ asset('storage/' . $pic->image) }}" alt="{{ $pic->rating_text }}"
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs text-gray-500 uppercase tracking-tighter mt-0.5">Highlight Overlay
                                        Text</div>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('accommodation-highlight-pic.edit', $pic) }}"
                                            class="p-2 text-secondary hover:bg-green-400 hover:text-white rounded-lg transition-all"
                                            title="Edit Highlight Image">
                                            <i class="fas fa-edit"></i>
                                        </a>

                                        {{-- Delete --}}
                                        {{-- <form method="POST"
                                            action="{{ route('accommodation-highlight-pic.destroy', $pic) }}"
                                            onsubmit="return confirm('Are you sure you want to delete this highlight image?')"
                                            class="inline-block">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                class="p-2 text-red-500 hover:bg-red-500 hover:text-white rounded-lg transition-all"
                                                title="Delete Highlight Image">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No highlight images found.</p>
                                        <a href="{{ route('accommodation-highlight-pic.create') }}"
