        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-question-circle mr-2 text-primary"></i> FAQs
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage frequently asked questions and their visibility on the frontend.</p>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-primary text-white">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest">Question</th>
                        ...
                        @forelse($faqs as $faq)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="h-10 w-10 flex items-center justify-center bg-gray-100 rounded-lg border border-gray-200 text-primary">
                                        @if($faq->icon)
                                            <i class="{{ $faq->icon }} text-lg"></i>
                                        @else
                                            <i class="fas fa-question text-sm text-gray-300"></i>
                                        @endif
                                    </div>
                                </td>
                                ...
                                {{-- Question --}}
                                <td class="px-6 py-4">
                                    <div class="text-sm font-bold text-gray-900 line-clamp-1">{{ $faq->question }}</div>
                                    <div class="text-xs text-gray-500 line-clamp-1 mt-0.5">{{ Str::limit($faq->answer, 60) }}</div>
                                </td>
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <a href="{{ route('faqs.create') }}"
                                            class="mt-2 text-primary hover:underline text-sm font-semibold">Create your first FAQ</a>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
