{{-- resources/views/admin/about-header/index.blade.php --}}
@extends('admin.layouts.app')

@section('title', 'About Headers')
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">
                    <i class="fas fa-heading mr-2 text-primary"></i> About Headers
                </h1>
                <p class="text-sm text-gray-500 mt-1">Manage the badge text and main title for the "About Us" section.</p>
            </div>

            {{-- <a href="{{ route('about-header.create') }}"
                        ...
                        @forelse($headers as $item)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="px-3 py-1 bg-gray-100 text-gray-700 text-xs font-bold rounded-md border border-gray-200 uppercase tracking-tighter">
                                        {{ $item->badge_text }}
                                    </span>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center space-x-2">
                                        {{-- Edit --}}
                                        <a href="{{ route('about-header.edit', $item) }}"
                                        ...
                                        {{-- Delete --}}
                                        {{-- <form method="POST" action="{{ route('about-header.destroy', $item) }}"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 font-medium">No about headers found.</p>
                                        <a href="{{ route('about-header.create') }}"
